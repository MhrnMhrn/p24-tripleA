...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 0joWdd7dF6TQ/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__ur9F9)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__ecYiI)}
              role={"img"}
            />
          ),
