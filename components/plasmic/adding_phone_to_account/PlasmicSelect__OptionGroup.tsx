...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: 5yM8zONW-tZr/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: gUaVsqdTGH_a/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__r56Np)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__mHcGz)}
              />
            </React.Fragment>
          ),
          value: args.children
